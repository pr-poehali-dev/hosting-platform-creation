  ...
  const hostingPlans = [
    {
      name: 'Стартовый',
      price: '290',
      features: ['1 сайт', '5 ГБ SSD', '10 ГБ трафика', 'SSL сертификат', 'Техподдержка 24/7'],
      popular: false
    },
    {
      name: 'Бизнес',
      price: '690',
      features: ['5 сайтов', '20 ГБ SSD', '100 ГБ трафика', 'SSL сертификат', 'Приоритетная поддержка', 'Ежедневные бэкапы'],
      popular: true
    },
    {
      name: 'Корпоративный',
      price: '1490',
      features: ['Безлимит сайтов', '100 ГБ SSD', '500 ГБ трафика', 'Выделенный IP', 'Премиум поддержка', 'Панель управления Pro'],
      popular: false
    }
  ];

  const services = [
    { icon: 'Server', title: 'Веб-хостинг', description: 'Надежный хостинг для ваших сайтов с гарантией 99.9% аптайма' },
    { icon: 'Database', title: 'Базы данных', description: 'MySQL, PostgreSQL и другие СУБД с высокой производительностью' },
    { icon: 'Shield', title: 'SSL сертификаты', description: 'Бесплатные и премиум SSL сертификаты для защиты данных' },
    { icon: 'Network', title: 'CDN', description: 'Глобальная сеть доставки контента для ускорения сайтов' }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              <a href="#home" className="text-gray-900 hover:text-primary font-medium transition-colors">Главная</a>
              <a href="#pricing" className="text-gray-600 hover:text-primary font-medium transition-colors">Тарифы</a>
              <a href="#services" className="text-gray-600 hover:text-primary font-medium transition-colors">Услуги</a>
              <a href="#about" className="text-gray-600 hover:text-primary font-medium transition-colors">О нас</a>
              <a href="#contact" className="text-gray-600 hover:text-primary font-medium transition-colors">Контакты</a>
            </nav>
            <Button>Войти</Button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-5xl font-bold text-gray-900 mb-6">
              Профессиональный хостинг<br />для вашего бизнеса
            </h2>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Надежная платформа с панелью управления, статистикой в реальном времени 
              и полным контролем над вашими проектами
            </p>
            <div className="flex justify-center space-x-4">
              <Button size="lg" className="px-8 py-3">Начать работу</Button>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-bold text-gray-900 mb-4">Панель управления</h3>
            <p className="text-xl text-gray-600">Полный контроль над вашим хостингом</p>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                  <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                      <CardTitle className="text-sm font-medium">Активные сайты</CardTitle>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground">73% от лимита</p>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground">56% используется</p>
                    </CardContent>
                  </Card>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex-1">
                            <p className="text-sm font-medium">SSL сертификат обновлен</p>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex-1">
                            <p className="text-sm font-medium">Создан бэкап сайта example.com</p>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex-1">
                            <p className="text-sm font-medium">Превышен лимит трафика на 75%</p>
              ...
              <TabsContent value="performance" className="mt-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-green-600 mb-2">234 ms</div>
                      <p className="text-sm text-muted-foreground">Среднее время отклика за 24 часа</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardHeader>
                    ...
                    <CardContent>
                      ...
                      <p className="text-sm text-muted-foreground">Текущая средняя нагрузка</p>
                    </CardContent>
                  </Card>
                </div>
              </TabsContent>
              ...
              <TabsContent value="security" className="mt-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <Card>
                    ...
                    <CardContent>
                      <div className="flex items-center space-x-2 mb-4">
                        ...
                        <span className="font-medium text-green-600">Защищено</span>
                      </div>
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between">
                          ...
                          <Badge variant="outline" className="text-green-600">Включен</Badge>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-sm">Антивирус</span>
                          <Badge variant="outline" className="text-green-600">Обновлен</Badge>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-sm text-muted-foreground">За последние 30 дней угрозы не обнаружены</p>
                    </CardContent>
                  </Card>
                </div>
              </TabsContent>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Получать уведомления о статусе сервисов</p>
                        </div>
                      ...
                      <div className="flex justify-between items-center">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Ежедневные резервные копии</p>
                        </div>
      ...
      <section id="pricing" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Выберите подходящий план для вашего проекта</p>
          </div>
      ...
      <section id="services" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Комплексные решения для вашего онлайн-присутствия</p>
          </div>
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h3 className="text-4xl font-bold text-gray-900 mb-6">О нашей платформе</h3>
              <p className="text-lg text-gray-600 mb-6">
                Мы предоставляем надежные хостинг-услуги с 2015 года, обслуживая более 10,000 клиентов 
                по всему миру. Наша миссия — обеспечить стабильную и безопасную работу ваших проектов.
              </p>
            ...
            <div className="bg-gradient-to-br from-primary/10 to-primary/20 rounded-lg p-8">
              <div className="text-center">
                ...
                <h4 className="text-2xl font-bold mb-4">Сертифицированное качество</h4>
                <p className="text-gray-600">
                  Наши услуги соответствуют международным стандартам качества и безопасности
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="contact" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Готовы помочь с любыми вопросами</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card className="text-center">
              <CardHeader>
                <Icon name="MessageCircle" className="h-8 w-8 text-primary mx-auto mb-4" />
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white transition-colors">Веб-хостинг</a></li>
                ...
                <li><a href="#" className="hover:text-white transition-colors">SSL сертификаты</a></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 HostPlatform. Все права защищены.</p>
          </div>
        </div>
      </footer>
    </div>
